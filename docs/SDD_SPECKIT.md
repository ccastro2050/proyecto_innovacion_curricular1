...
| Tabla | PK | Semilla |
|---|---|---|
| aliado | nit | sin filas: la tabla arranca vacía |
...
```bash
curl http://localhost:8072/api/aliado        # total: 8
curl -i http://localhost:8072/api/aliado/PR999   # → 404
```
...
- [ ] Modelos/Aliado.cs (la entidad: 4 propiedades tipadas)
- [ ] Peticiones/AliadoCrear.cs (todo obligatorio, con [Required])
